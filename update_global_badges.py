...
def get_scraped_data_playwright():
    print("DEBUG: Cloudscraper challenged. Using Playwright fallback...")
...
def parse_html(html_content):
    ...
    for link in links:
        ...
        # Structure: twitch / global-badges / [set_id] / [version_id]
        if len(parts) >= 3:
            s_id = parts[2]
...
def get_scraped_data():
    try:
        print("DEBUG: Starting scrape with Cloudscraper...")
        ...
        print(f"DEBUG: Scraper primary failed: {e}")
        html = get_scraped_data_playwright()
